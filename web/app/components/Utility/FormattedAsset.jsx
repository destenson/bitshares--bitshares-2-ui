    ...
    render() {
        ...
        return (
                ...
                {!hide_asset && (this.props.assetInfo ? (
                    ...
                    <span className="currency" onClick={this.togglePopover}> <AssetName noTip={this.props.noTip} noPrefix={this.props.noPrefix} name={asset.symbol} withTooltip={withTooltip} replace={this.props.replace} /></span>)}
                </span>
        );
    }
}
