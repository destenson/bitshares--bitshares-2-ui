...
class MarketGroup extends React.Component {
    ...
    static defaultProps = {
        maxRows: 20000 // DEE: a large number changed from 20, too large?
    };
...
class MyMarkets extends React.Component {
    ...
    render() {
        ...
        if (activeMarkets.size > 0) {
            ...
            .take(activeTab === "starred" ? 60 : 35) // DEE: changed from 100 : 20
            .toArray();
        }
                ...
                >
                    ...
                    {preferredBases.filter(a => {return a === preferredBases.get(activeMarketTab);}).map((base, index) => {
                        return <MarketGroup
                            ...
                            base={base}
                            maxRows={myMarketTab ? 60 : 35} // DEE: Changed from 20 : 10
